...
const (
	...
	OutDir    = "5_train_noncovers_img"
	songLimit = 1209 //
	fileLimit = 1209 //should be equal
	procCount = 20
)
...
func crossSimilarity(stop chan bool, c chan [2]*exec.Cmd, refDir string, queryDir string) {
	...
	csvCommand := exec.Command("./crosssimilarity2.py", refFileDir, queryFileDir, outputDir) // crosssimilarity2 for reversed
