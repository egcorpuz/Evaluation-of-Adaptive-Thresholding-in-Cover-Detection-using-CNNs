...
model = tf.keras.models.Sequential([
    # Block 1
    tf.keras.layers.Conv2D(32,(5,5),activation = "relu", input_shape = (180,180,3), padding = "same"),
    ...
    tf.keras.layers.Dropout(0.25,seed = 69420),
...
model.save("Adaptive_Trained_Model_2k.h5")
print("Model Saved")
